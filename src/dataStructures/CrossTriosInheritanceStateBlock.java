...
/**
 * Continuous block on a chromosome having the same {@link CrossTriosInheritanceState} 
 * @author Julien Lajugie
 */
public class CrossTriosInheritanceStateBlock implements InheritanceStateBlock<CrossTriosInheritanceState> {
	
	private final CrossTriosInheritanceState 	blockState;				// inheritance state of the block
	...
	/**
	 * Creates an instance of {@link CrossTriosInheritanceStateBlock}
	 * @param blockState {@link CrossTriosInheritanceState} of the block. Should be null if the block is partial
	 ...
	 */
	public CrossTriosInheritanceStateBlock(CrossTriosInheritanceState blockState, String chromosome, int startPosition, int stopPosition) {
		super();
